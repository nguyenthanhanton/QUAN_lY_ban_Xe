...
namespace DAI_LY_BAN_Xe
{
    public partial class form_admin: Form
    {
        ...
        public form_admin(string tenTaiKhoan)
        {
            InitializeComponent();
        ...
        private void HienThiThongTinTaiKhoan(string tenTK)
        {
            ...
            WHERE TK.TAIKHOAN = @taikhoan";
                ...
                using (SqlCommand cmd = new SqlCommand(query, conn))
                {
                    ...
                    if (reader.Read())
                    {
                        txt_TenTK.Text = reader["TAIKHOAN"].ToString();
                        txt_QuyenHan.Text = reader["QUYENHAN"].ToString();
                        txt_MaNv.Text = reader["Manv"].ToString();
                        txt_TenNV.Text = reader["TENNV"].ToString();
                        txt_ChucVu.Text = reader["CHUCVU"].ToString();
                        txt_Email.Text = reader["EMAIL"].ToString();
                        txt_SDTad.Text = reader["SDTNV"].ToString();
        ...
        private void btn_SuaTTAD_Click(object sender, EventArgs e)
        {
        ...
        {
            form_ThemTK frm = new form_ThemTK();  // Tạo form thêm tài khoản mới
            frm.ShowDialog(); // Hiển thị dưới dạng cửa sổ modal
        }
    }
}
